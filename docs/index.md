...
Each capability is tagged with its evidence tier — see [Validation](validation.md) for the oracle/corpus backing every claim and the steps to reproduce it. See [Formats](formats.md) for the supported-format matrix.
