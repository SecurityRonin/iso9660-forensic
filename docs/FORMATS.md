...
| B5T/B6T (BlindWrite) | ❌ | low | Undeciphered in libmirage but **Aaru reads it** — same multi-sample + Aaru-oracle approach as CDI is viable next cycle |
| DAA | ❌ | low | proprietary/encrypted (PowerISO) — likely out of scope |
