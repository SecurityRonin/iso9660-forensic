...
use std::io::Cursor;
use iso9660_forensic::{IsoError, IsoReader, rock_ridge};
...
fn write_empty_dir(img: &mut [u8], sec: usize, self_lba: u32, parent_lba: u32) {
    ...
    d[25] = 0x02; d[32] = 1;
    let o = 34;
    d[o] = 34; d[o+2..o+6].copy_from_slice(&parent_lba.to_le_bytes());
...
fn write_dir_entry(img: &mut [u8], dir_sec: usize, off: usize, name: &[u8], lba: u32, size: u32, flags: u8) {
