...
fn decode_single_pack_album_and_track_title() {
    ...
    let pack: [u8; 18] = [
        0x80, 0x00, 0x00, 0x00, 0x41, 0x4C, 0x42, 0x55, 0x4D, 0x00, 0x53, 0x4F, 0x4E, 0x47, 0x31,
        0x00, 0x41, 0xD2,
    ];
    let ct = decode(&pack);
...
fn decode_performer_spanning_two_packs() {
    ...
    let blob: [u8; 36] = [
        0x81, 0x00, 0x00, 0x00, 0x42, 0x41, 0x4E, 0x44, 0x00, 0x41, 0x52, 0x54, 0x49, 0x53, 0x54,
        0x20, 0xEE, 0x45, 0x81, 0x01, 0x01, 0x00, 0x4F, 0x4E, 0x45, 0x20, 0x58, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x91, 0x13,
    ];
    let ct = decode(&blob);
